...
locals {
  ...
  lb_listener_paths          = ["/notification-sender/letter", "/notification-sender/email", "/health"]
  healthcheck_path           = "/health" # healthcheck path for chs-notification-sender-api service
